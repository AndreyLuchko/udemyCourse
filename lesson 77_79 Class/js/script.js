document.addEventListener('DOMContentLoaded', () => {
    ...
    class CardsMenu {
        constructor (src, alt, title, text, price, parentSection) {
            this.src = src;
            this.alt = alt;
            this.title = title;
            this.text = text;
    ...
    menu.forEach(item => {
        new CardsMenu(item.src, item.alt, item.title, item.text, item.price, '.menu .container').render();
    });
